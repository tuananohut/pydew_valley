...
class Menu:
    def __init__(self, player, toggle_menu):
        ...
        self.font = pygame.font.Font("C:/Users/tuana/Desktop/PYTHON_PROJELER/pydew_valley/font/LycheeSoda.ttf", 30)
    ...
    def setup(self):
        ...
        for item in range(len(self.options)):
            if item < len(self.options) - 2:
                text_surf = self.font.render(self.options[item], False, 'Black')
                self.text_surfs.append(text_surf)
                self.total_height += text_surf.get_height() + (self.padding * 2)
            else:
                text_surf = self.font.render(self.options[item] + ' seed', False, 'Black')
                self.text_surfs.append(text_surf)
                self.total_height += text_surf.get_height() + (self.padding * 2)
